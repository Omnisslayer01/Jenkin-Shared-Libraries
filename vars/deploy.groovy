def call(String container_name){
  ...
  sh "docker run -d -p '8000:8000' --name django_app --network=mynetwork -e MYSQL_ROOT_PASSWORD=root -e MYSQL_DATABASE=db -e MYSQL_HOST=mysql_db -e MYSQL_USER='root' ${container_name}"
